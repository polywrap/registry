...
const ImplementationRegistryComponent: React.FC = () => {
  ...
  return (
    <div className="ImplementationRegistryComponent widget">
      ...
      <div>
        ...
        <button
          className="register-implementation"
          onClick={async () => {
            ...
            registerImplementation(
              ...
              .then(() => {
                addToast(
                  `Registered ${implementationToRegister} as implementation of ${interfaceToRegister}.`,
...
export default ImplementationRegistryComponent;
