...
export interface TestENSRegistryInterface extends utils.Interface {
  functions: {
...
export interface TestENSRegistry extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestENSRegistryInterface;
