...
export interface TestPublicResolverInterface extends utils.Interface {
  functions: {
...
export interface TestPublicResolver extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestPublicResolverInterface;
