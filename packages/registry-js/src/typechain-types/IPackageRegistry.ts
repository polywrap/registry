...
export interface IPackageRegistryInterface extends utils.Interface {
  functions: {
...
export interface IPackageRegistry extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IPackageRegistryInterface;
