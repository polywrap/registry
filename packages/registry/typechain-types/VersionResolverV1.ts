...
export interface VersionResolverV1Interface extends utils.Interface {
  functions: {
...
export interface VersionResolverV1 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: VersionResolverV1Interface;
