...
import type {
  VersionRegistryV1,
  VersionRegistryV1Interface,
} from "../VersionRegistryV1";
...
export class VersionRegistryV1__factory {
  static readonly abi = _abi;
  static createInterface(): VersionRegistryV1Interface {
    return new utils.Interface(_abi) as VersionRegistryV1Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): VersionRegistryV1 {
    return new Contract(address, _abi, signerOrProvider) as VersionRegistryV1;
  }
}
