...
import type {
  IPackageRegistry,
  IPackageRegistryInterface,
} from "../IPackageRegistry";
...
export class IPackageRegistry__factory {
  static readonly abi = _abi;
  static createInterface(): IPackageRegistryInterface {
    return new utils.Interface(_abi) as IPackageRegistryInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IPackageRegistry {
    return new Contract(address, _abi, signerOrProvider) as IPackageRegistry;
  }
}
