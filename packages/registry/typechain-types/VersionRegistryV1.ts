...
export interface VersionRegistryV1Interface extends utils.Interface {
  functions: {
...
export interface VersionRegistryV1 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: VersionRegistryV1Interface;
